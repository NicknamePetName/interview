...
import com.yixin.interview.manager.DeepSeekManager;
import com.yixin.interview.mapper.MockInterviewMapper;
import com.yixin.interview.model.dto.mockinterview.MockInterviewAddRequest;
import com.yixin.interview.model.dto.mockinterview.MockInterviewChatMessage;
import com.yixin.interview.model.dto.mockinterview.MockInterviewEventRequest;
import com.yixin.interview.model.dto.mockinterview.MockInterviewQueryRequest;
import com.yixin.interview.model.entity.MockInterview;
import com.yixin.interview.model.entity.User;
import com.yixin.interview.model.enums.MockInterviewEventEnum;
import com.yixin.interview.model.enums.MockInterviewStatusEnum;
import com.yixin.interview.service.MockInterviewService;
...
public class MockInterviewServiceImpl extends ServiceImpl<MockInterviewMapper, MockInterview>
    ...
    private String handleChatEndEvent(MockInterview mockInterview) {
        ...
        // 调用 AI 获取结果
        String endAnswer = deepSeekManager.doChat(chatMessages);
    ...
    private String handleChatMessageEvent(MockInterviewEventRequest mockInterviewEventRequest, MockInterview mockInterview) {
        ...
        // 调用 AI 获取结果
        String chatAnswer = deepSeekManager.doChat(chatMessages);
    ...
    private String handleChatStartEvent(MockInterview mockInterview) {
        ...
        // 调用 AI 获取结果
        String answer = deepSeekManager.doChat(messages);
