...
import com.yixin.interview.mapper.QuestionMapper;
import com.yixin.interview.model.dto.question.QuestionEsDTO;
...
//            questionVO.setHasFavour(questionIdHasFavourMap.getOrDefault(questionVO.getId(), false));
    ...
    public boolean aiGenerateQuestions(String questionType, int number, User user) {
        ...
        // 3. 调用 AI 生成题目
        String answer = deepSeekManager.doChat(systemPrompt, userPrompt);
        // 4. 对题目进行预处理
        // 按行拆分
    ...
    private String aiGenerateQuestionAnswer(String questionTitle) {
        ...
        // 3. 调用 AI 生成题解
        return deepSeekManager.doChat(systemPrompt, userPrompt);
    }
