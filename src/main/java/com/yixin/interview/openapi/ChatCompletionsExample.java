package com.yixin.interview.openapi;
...
public class ChatCompletionsExample {
    ...
    static String apiKey = "1d9dadae-3f70-4d85-b919-decfa9205164";
    ...
    public static void main(String[] args) {
        ...
        final ChatMessage systemMessage = ChatMessage.builder().role(ChatMessageRole.SYSTEM).content("你是一名资深技术面试官").build();
